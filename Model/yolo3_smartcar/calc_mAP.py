...
def get_map(MINOVERLAP, draw_plot, score_threhold=0.5, path = './map_out'):
    ...
    if draw_plot:
        ...
        if not os.path.exists(os.path.join(RESULTS_FILES_PATH, "AP")):
            os.makedirs(os.path.join(RESULTS_FILES_PATH, "AP"))
        if not os.path.exists(os.path.join(RESULTS_FILES_PATH, "F1")):
            os.makedirs(os.path.join(RESULTS_FILES_PATH, "F1"))
        if not os.path.exists(os.path.join(RESULTS_FILES_PATH, "Recall")):
            os.makedirs(os.path.join(RESULTS_FILES_PATH, "Recall"))
        if not os.path.exists(os.path.join(RESULTS_FILES_PATH, "Precision")):
            os.makedirs(os.path.join(RESULTS_FILES_PATH, "Precision"))
    if show_animation:
        if not os.path.exists(os.path.join(RESULTS_FILES_PATH, "images", "detections_one_by_one")):
